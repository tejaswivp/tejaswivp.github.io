<h1 align="center">Hi, I'm Tejaswi V. Panchagnula 👋</h1>

<h3 align="center">
  🎓 MS ECE Student @ Purdue University<br>
  (Advised by Dr. Fengqing Maggie Zhu, VIPER Lab)<br>
  🧠 Deep Learning | 👁️ Computer Vision | ☁️ Agentic AI & Cloud
</h3>

<p align="center">
  <a href="https://tejaswivp.github.io/"><strong>🌐 Personal Website</strong></a> •
  <a href="https://www.linkedin.com/in/tejaswi-panchagnula-5b8b2a236"><strong>👔 LinkedIn</strong></a> •
  <a href="mailto:tpanchag@purdue.edu"><strong>📧 Email</strong></a>
</p>
...
### 📄 [Agentic AI PDF Editor](https://pdf-form-editor-gilt.vercel.app/)
*> An intelligent, agentic document processing platform.*

I engineered a full-stack AI platform that uses Computer Vision and LLMs to interactively edit and fill PDF forms via natural language.
- **The Tech:** Built with **React (Konva/Framer Motion)** frontend and **FastAPI** backend.
- **Agentic AI:** Integrated **Google Gemini 2.5** to power a conversational agent that executes commands (e.g., *"Set the date to today and clear the signature"*).
...
- **Innovation:** Implemented a constrained decoding framework to enforce strict JSON output schemas, ensuring deterministic execution from stochastic LLM outputs.
- **Impact:** Automates IT triage by chaining LLM reasoning with deterministic Python logic.
...
| **Cloud & Backend** | **AWS (Lambda, Bedrock)**, FastAPI, Docker, PySpark, Vercel |
| **AI Frameworks** | PyTorch, TensorFlow, YOLO, LightGBM, LangChain, OpenCV |
| **GenAI Models** | **Gemini 2.5**, **Claude 3 Haiku**, GPT-5, HuggingFace Transformers |
| **Frontend** | React, Konva, Framer Motion, Streamlit |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=tejaswivp&layout=compact&theme=vision-friendly-dark" alt="Tejaswi's Top Languages" />
</p>
